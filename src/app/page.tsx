    ...
    <div className="m-0 p-6 h-screen overflow-x-hidden overflow-y-auto flex flex-col justify-start">
      ...
      >
        <FlickeringGrid
          ...
          height={1080}
        />
        <h1 className="z-30 pointer-events-none p-6 text-[64px] max-md:text-[48px] text-center font-iosevkaMedium">
          Pass Gen
        </h1>
      </div>
      ...
      <div
        className="mt-4 mb-auto ml-auto mr-auto w-8/12 max-2xl:w-9/12 max-xl:w-10/12 max-lg:w-11/12 max-md:w-full 
                   p-8 border border-gray-900 rounded-lg backdrop-blur-md z-50"
      >
        <Generator />
      </div>
    </div>
